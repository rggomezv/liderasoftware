...
@Component({
  selector: 'app-modal-tb-view',
  templateUrl: './modal-tb-view.component.html',
  styleUrls: ['./modal-tb-view.component.css']
})
export class ModalTbViewComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<ModalTbViewComponent>,
